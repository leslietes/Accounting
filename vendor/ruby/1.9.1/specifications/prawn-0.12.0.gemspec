...
Gem::Specification.new do |s|
  ...
  s.authors = [%q{Gregory Brown}, %q{Brad Ediger}, %q{Daniel Nelson}, %q{Jonathan Greenberg}, %q{James Healy}]
  s.date = %q{2011-08-13}
  ...
  s.extra_rdoc_files = [%q{README.md}, %q{LICENSE}, %q{COPYING}, %q{GPLv2}, %q{GPLv3}]
  s.files = [%q{README.md}, %q{LICENSE}, %q{COPYING}, %q{GPLv2}, %q{GPLv3}]
